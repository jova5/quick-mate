...
import InProgressPosts from "@/app-components/InProgressPosts";
import YourPosts from "@/app-components/YourPosts";
import CompletedPosts from "@/app-components/CompletedPosts";
      ...
      <Container style={styles.container}>
        <View style={
          ...
          <View style={{
            ...
            }}>{(user && user.cityName !== undefined && user.cityName !== null) ? user.cityName : t("city")}</Button>
            <IconButton
